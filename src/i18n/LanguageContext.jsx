...
const translations = {
  ...
  en: {
    ...
    members: { title: 'Members', pageTitle: 'Members | Latvian Fire Safety Association', meta: 'Member companies of the Latvian Fire Safety Association.', heading: 'MEMBERS OF THE LATVIAN FIRE SAFETY ASSOCIATION', logoSuffix: 'logo', visit: 'Visit website', loading: 'Loading members...', error: 'Members cannot be loaded right now.', empty: 'There are no members to display yet.', joinHeading: 'BECOME A LUA MEMBER', joinText: 'Join more than 120 companies creating a safer Latvia.', apply: 'Apply now' },
