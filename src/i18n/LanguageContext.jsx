...
const translations = {
  lv: {
    ...
    home: {
      ...
      joinText: 'Pievienojieties vairāk nekā 120 uzņēmumiem, kas veido drošāku Latviju.',
    },
    about: {
      title: 'Par mums',
      ...
      offerHeading: 'MŪSU BIEDRU PIEDĀVĀJUMI UN PAKALPOJUMI',
    ...
    members: { title: 'Biedri', pageTitle: 'Biedri | Latvijas Ugunsdrošības asociācija', meta: 'Latvijas Ugunsdrošības asociācijas biedru uzņēmumi.', heading: 'LATVIJAS UGUNSDROŠĪBAS ASOCIĀCIJAS BIEDRI', honoraryHeading: 'GODA BIEDRI', logoSuffix: 'logotips', visit: 'Apmeklēt vietni', joinHeading: 'KĻŪSTIET PAR LUA BIEDRU', joinText: 'Pievienojies vairāk nekā 120 uzņēmumiem, kas veido drošāku Latviju.', apply: 'Piesakieties' },
  ...
  en: {
    ...
    members: { title: 'Members', pageTitle: 'Members | Latvian Fire Safety Association', meta: 'Member companies of the Latvian Fire Safety Association.', heading: 'MEMBERS OF THE LATVIAN FIRE SAFETY ASSOCIATION', honoraryHeading: 'HONORARY MEMBERS', logoSuffix: 'logo', visit: 'Visit website', joinHeading: 'BECOME A LUA MEMBER', joinText: 'Join more than 120 companies creating a safer Latvia.', apply: 'Apply now' },
