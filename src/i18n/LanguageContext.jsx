...
const translations = {
  lv: {
    ...
    legal: {
      ...
      pageTitle: 'Juridiskā informācija | Latvijas Ugunsdrošības asociācija',
      meta: 'Latvijas Ugunsdrošības asociācijas vietnes juridiskā informācija.',
      intro: 'Šajā sadaļā ir sniegta informācija par vietnes operatoru un šīs vietnes izmantošanas pamatnoteikumiem.',
      sections: [
        { title: 'Vietnes operators', paragraphs: ['Latvijas Ugunsdrošības asociācija BIEDRĪBA', 'Reģ. Nr. 40008066462', 'Vijciema iela 1A, Rīga, LV-1006'] },
        { title: 'Vietnes saturs', paragraphs: ['Vietnes saturs ir paredzēts informatīviem nolūkiem. Asociācija cenšas to uzturēt aktuālu, tomēr negarantē, ka visa publicētā informācija vienmēr ir pilnīga vai bez kļūdām. Pirms pieņemat lēmumu, kas balstīts uz vietnes informāciju, izvērtējiet attiecīgos normatīvos aktus un konsultējieties ar kvalificētu speciālistu.'] },
        { title: 'Autortiesības un saites', paragraphs: ['Ja nav norādīts citādi, vietnes teksts, dizains un Asociācijai piederošie attēli ir aizsargāti. To atkārtotai izmantošanai ir nepieciešama Asociācijas atļauja vai cits piemērojams tiesiskais pamats.', 'Vietnē var būt saites uz trešo personu vietnēm. Asociācija nekontrolē šo vietņu saturu, pieejamību vai privātuma praksi un neatbild par to izmantošanu.'] },
      ],
      privacy: { title: 'Privātums', body: 'Informāciju par personas datu apstrādi un jūsu tiesībām skatiet privātuma politikā. Jautājumiem par datu apstrādi izmantojiet zemāk norādīto e-pasta adresi.', link: 'Atvērt privātuma politiku' },
    },
