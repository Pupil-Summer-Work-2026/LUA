...
const translations = {
  lv: {
    ...
    footer: {
      ...
      copyright: '© {year} Latvijas Ugunsdrošības asociācija. Visas tiesības aizsargātas.',
    ...
    home: {
      ...
      services: [
        ...
        ['Ugunsdrošība', ' Mūsu asociācijas biedri nodrošina ugunsdrošības pasākumus un sniedz ugunsdrošības pakalpojumus, lai aizsargātu cilvēkus un īpašumu.'],
      ],
      newsEyebrow: 'JAUNUMI',
    ...
    about: {
      ...
      intro: [
        'Biedrības mērķis ir Latvijas Republikas ugunsdrošības servisa uzņēmumu un darbinieku apvienošana kopīgam radošam darbam un to interešu aizsardzība.',
        ...
        '“Latvijas Ugunsdrošības asociācija” dibināta 2002. gadā un uz pašreizējo brīdi apvieno vairākus Latvijas un starptautiskos vadošos ugunsdrošības servisa uzņēmumus. Biedrība sadarbojas ar citām sabiedriskām organizācijām. “Latvijas Ugunsdrošības asociācija” ir “Latvijas Darba Devēju Konfederācijas” biedrs.',
      ],
      ...
      sectors: ['Visa veida ugunsdzēsības aparātu, inventāra, tehnikas un speciālā aprīkojuma tirdzniecība, apkope un uzpildīšana', 'Būvprojektu ugunsdrošības risinājumu projektēšana un ekspertīze. Ugunsdrošības pasākumu pārskatu un risinājumu izstrāde', 'Individuālo un speciālo drošības un aizsardzības līdzekļu un aprīkojuma tirdzniecība', 'Būvkonstrukciju apstrāde ar ugunsaizsardzības pārklājumiem, to tirdzniecība. Inženierkomunikāciju ugunsaizsardzība. Pasīvā ugunsaizsardzība.', 'Objektu ugunsdrošības audīti, apsekošanas, novērtējumi', 'Ugunsdrošās durvju un vārtu, kā arī stikla-alumīnija konstrukciju (logi, durvis, starpsienas, virsgaismas, fasādes utt.) tirdzniecība', 'Elektrotehniskie mērījumi. Zibens novadītāju projektēšana un uzstādīšana', 'Elektroinstalācijas un kabeļu nesošās sistēmas, tostarp kabeļu renes, kāpnes, kanāli, caurules, instalācijas kārbas un stiprinājumi. Sertificēti ugunsnoturīgi risinājumi drošai kabeļu instalācijai', ' Automātisko ugunsdzēsības sistēmu, t.sk., dūmu un karstuma kontroles sistēmu projektēšana, montāža, testēšana, apkalpošana un materiālu/iekārtu tirdzniecība.', 'Ugunsdzēsības iekšējo un ārējo ūdensapgādes sistēmu projektēšana, montāža, apkalpošana un ūdensvada spiediena pārbaudes', 'Apkures un ventilācijas sistēmu apkalpošana', 'Ugunsdrošības un civilās aizsardzības apmācības. Ugunsdrošības instruktāžas. Ugunsdrošības dokumentācijas un evakuācijas plānu izstrāde'],
    },
    ...
    privacy: {
      ...
      sections: [
        { title: 'Pārzinis', paragraphs: ['Personas datu pārzinis ir Latvijas Ugunsdrošības asociācija BIEDRĪBA, reģ. Nr. 40008066462, juridiskā adrese: Vijciema iela 1A, Rīga, LV-1006. Privātuma jautājumu forma ir atrodama šīs politikas beigās.'] },
      ...
      contact: { title: 'Privātuma un politikas jautājumi', body: 'Lai izmantotu savas tiesības vai uzdotu jautājumu par šo politiku, sazinieties ar Asociāciju, izmantojot šo formu:' },
  ...
  en: {
    ...
    footer: {
      ...
      copyright: '© {year} Latvian Fire Safety Association. All rights reserved.',
    ...
    privacy: {
      ...
      sections: [
        { title: 'Controller', paragraphs: ['The controller is Latvijas Ugunsdrošības asociācija BIEDRĪBA, registration No. 40008066462, registered address: Vijciema iela 1A, Riga, LV-1006, Latvia. The privacy contact form appears at the end of this policy.'] },
      ...
      contact: { title: 'Privacy contact', body: 'To exercise your rights or ask a question about this policy, contact the Association using this form:' },
