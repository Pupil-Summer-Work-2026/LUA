...
const translations = {
  lv: {
    ...
    about: {
      ...
      offerEyebrow: 'MŪSU PIEDĀVĀJUMS BIEDRIEM',
      offerHeading: 'PIEDĀVĀJUMI UN PAKALPOJUMI',
    ...
    members: { title: 'Biedri', pageTitle: 'Biedri | Latvijas Ugunsdrošības asociācija', meta: 'Latvijas Ugunsdrošības asociācijas biedru uzņēmumi.', heading: 'LATVIJAS UGUNSDROŠĪBAS ASOCIĀCIJAS BIEDRI', logoSuffix: 'logotips', visit: 'Apmeklēt vietni', joinHeading: 'KĻŪSTIET PAR LUA BIEDRU', joinText: 'Pievienojies vairāk nekā 120 uzņēmumiem, kas veido drošāku Latviju.', apply: 'Piesakieties' },
