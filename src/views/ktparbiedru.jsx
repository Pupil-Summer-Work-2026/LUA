...
const Ktparbiedru = (props) => {
  return (
    <div className="ktparbiedru-container1">
      <Helmet>
        <title>Ktparbiedru - exported project</title>
        <meta property="og:title" content="Ktparbiedru - exported project" />
        <link
          rel="canonical"
          href="https://first-lua-iteration-g24wha.teleporthq.site/ktparbiedru"
        />
        <meta
          property="og:url"
          content="https://first-lua-iteration-g24wha.teleporthq.site/ktparbiedru"
        />
      </Helmet>
      <div className="ktparbiedru-thq-ktparbiedru-elm">
        <img
          src="/rectangle131684-5dw-200h.png"
          alt="Rectangle131684"
        ...
        <img
          ...
          alt="Line41685"
          className="ktparbiedru-thq-line4-elm"
        />
        <span className="ktparbiedru-thq-text-elm15">
          Iestāšanās asociācijā
        </span>
        <img
          src="/line31685-8lx8.svg"
          alt="Line31685"
          className="ktparbiedru-thq-line3-elm1"
        />
        <img
          src="/image171686-9gsk-500h.png"
          alt="image171686"
          className="ktparbiedru-thq-image17-elm"
        />
        <span className="ktparbiedru-thq-text-elm16">
          <span className="ktparbiedru-thq-text-elm17">
            KĻŪSTI PAR
            <span
        ...
        <span className="ktparbiedru-thq-text-elm19">
          <span>
            Kļūt par biedru ir tik vienkārši! Tikai pārdod mums savu dvēseli un
            esi daļa no biedrības. :)
          </span>
          <br></br>
          <br></br>
          <span>
            Jebkura Latvijas Republikā reģistrēta juridiska persona vai
            tiesībspējīga personālsabiedrība, kas nodarbojas ar ugunsdzēsību vai
            ugunsdzēsības servisu, vai ir tieši saistīta ar to, un atbalsta
            Biedrības mērķus, kā arī apņemas ievērot tās statūtus.
          </span>
          <br></br>
          <br></br>
        </span>
        <span className="ktparbiedru-thq-text-elm22">
          Biedrības valdei iesniedzamie dokumenti
        </span>
        <img
          src="/rectangle281688-oc-200h.png"
          alt="Rectangle281688"
          className="ktparbiedru-thq-rectangle28-elm"
        />
        <span className="ktparbiedru-thq-text-elm23">
          <span className="ktparbiedru-thq-text-elm24">
            100%
            <span
              dangerouslySetInnerHTML={{
                __html: ' ',
          ...
          <span className="ktparbiedru-thq-text-elm25">FREE</span>
          <span className="ktparbiedru-thq-text-elm26">
            <span
              dangerouslySetInnerHTML={{
                __html: ' ',
              }}
        ...
        <img
          src="/ellipse21688-su7l-200h.png"
          alt="Ellipse21688"
          className="ktparbiedru-thq-ellipse2-elm"
        />
        <img
          src="/arrow41688-xos.svg"
          alt="Arrow41688"
          className="ktparbiedru-thq-arrow4-elm"
        />
        <span className="ktparbiedru-thq-text-elm28">NO VIRUS LEGIT</span>
        <img
          src="/rectangle301689-7fzc-1200w.png"
          alt="Rectangle301689"
          className="ktparbiedru-thq-rectangle30-elm"
        />
        <span className="ktparbiedru-thq-text-elm29">
          Lēmumu par biedra uzņemšanu Biedrībā pieņem valde. Valdei pieteicēja
          lūgums ir jāizskata tuvākās sēdes laikā, taču ne ilgāk kā divu nedēļu
          laikā no visu nepieciešamo dokumentu saņemšanas brīža. Uz valdes sēdi,
          kurā izskata pieteicēja lūgumu, ir jāuzaicina pats pieteicējs un jādod
          viņam vārds sava viedokļa paušanai. Pieteicēja neierašanās nav
          šķērslis valdes lēmuma pieņemšanai. Valdei motivēts lēmums rakstveidā
          jāpaziņo pieteicējam nedēļas laikā no tā pieņemšanas brīža.
        </span>
        <div className="ktparbiedru-thq-footer-elm1">
          <img
            src="/bg1681-hiip-400h.png"
            alt="BG1681"
            className="ktparbiedru-thq-bg-elm1"
          />
          <div className="ktparbiedru-thq-group2-elm1">
            <span className="ktparbiedru-thq-text-elm30">Navigācija</span>
            <span className="ktparbiedru-thq-text-elm31">Par mums</span>
            <span className="ktparbiedru-thq-text-elm32">Par mums</span>
            <span className="ktparbiedru-thq-text-elm33">Par mums</span>
          </div>
          <div className="ktparbiedru-thq-group1-elm1">
            <span className="ktparbiedru-thq-text-elm34">Navigācija</span>
            <span className="ktparbiedru-thq-text-elm35">Par mums</span>
            <span className="ktparbiedru-thq-text-elm36">Par mums</span>
            <span className="ktparbiedru-thq-text-elm37">Par mums</span>
          </div>
          <div className="ktparbiedru-thq-group3-elm1">
            <span className="ktparbiedru-thq-text-elm38">Kontakti</span>
            <span className="ktparbiedru-thq-text-elm39">Par mums</span>
          ...
          <span className="ktparbiedru-thq-text-elm42">
            Latvijas Ugunsdrošības asociācija — profesionāls atbalsts, izglītība
            un pārstāvniecība kopš 1994. gada.
          </span>
          <img
            src="/lualogofullwhite111681-vjn-200h.png"
            alt="LUAlogofullwhite111681"
            className="ktparbiedru-thq-lu-alogofullwhite11-elm1"
          />
          <span className="ktparbiedru-thq-text-elm43">
            © 2026 Latvijas Ugunsdrošības asociācija. Visas tiesības
            aizsargātas.
          </span>
          <img
            src="/line31681-fflp.svg"
            alt="Line31681"
            className="ktparbiedru-thq-line3-elm2"
          />
        </div>
        <div className="ktparbiedru-thq-footer-elm2">
          <img
