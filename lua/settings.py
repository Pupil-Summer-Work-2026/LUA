...
MEMBERSHIP_FORM_RECIPIENT = os.getenv('MEMBERSHIP_FORM_RECIPIENT', '')
CONTACT_FORM_RECIPIENT = os.getenv('CONTACT_FORM_RECIPIENT', '')
PRIVACY_POLICY_FORM_RECIPIENT = os.getenv('PRIVACY_POLICY_FORM_RECIPIENT', '')
REGISTRATION_FORM_RECIPIENT = os.getenv('REGISTRATION_FORM_RECIPIENT', '')
